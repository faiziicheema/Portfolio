  ...
  return (
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/faiziicheema", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.instagram.com/faizancheema2/#", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/faizan-mukhtar-55a266260", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open("https://www.facebook.com/faizan.cheema.3517/", "_blank")
          }
        >
