          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/faizancheema2/#",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/faizan-mukhtar-55a266260/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/faizan.cheema.3517/",
                    "_blank"
                  )
                }
              >
