      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Faizan Mukhtar,</span> a Web
            Developer
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            I love playing music, reading comics and playing games. I was completed my graduation from UAF. I am {getDate()}{" "}
